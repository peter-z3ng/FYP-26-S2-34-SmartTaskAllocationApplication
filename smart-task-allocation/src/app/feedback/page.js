...
export const metadata = {
  title: "User Feedback | TaskNova",
  description: "Read customer feedback and testimonials for TaskNova.",
};
        ...
        <div className="mt-5 grid gap-8 lg:grid-cols-[1fr_340px] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-200">
              Browse feedback from managers, supervisors, business owners, and operations teams using TaskNova for task allocation.
            </p>
          </div>
