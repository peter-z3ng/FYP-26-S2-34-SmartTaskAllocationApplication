...
export default function SideMenuLayout({ actor, title, subtitle, children }) {
  ...
  return (
    <main className="h-screen overflow-hidden bg-[#C7DDEB] text-[#07183b]">
      ...
      <div className={`flex h-[calc(100vh-3.5rem)] w-full gap-2 overflow-hidden bg-[#C7DDEB] ${isManager ? "pl-1 pb-2 pr-2 sm:pb-2 sm:pl-2 sm:pr-2 lg:pb-2 lg:pl-2 lg:pr-2" : "p-2"}`}>
        <div className={`hidden w-16 shrink-0 flex-col justify-between md:flex ${isManager ? "z-50" : "z-10 mt-28"}`}>
