...
function seedDemoDatabase() {
  return {
    ...
    organization: [
      {
        ...
        organization_name: "TaskNova Demo SME",
    ...
    profile: [
      { profile_id: "profile-platformadmin", user_id: "demo-platformadmin", full_name: "Platform Admin", phone_number: "+65 6000 1000", address: "TaskNova Platform Office", bio: "Responsible for monitoring the platform and public website.", created_at: now(), updated_at: now() },
